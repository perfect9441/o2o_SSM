...
//						$('#shop-update-time').html(new Date(shop.lastEditTime).Format("yyyy-MM-dd")); format已被弃用
...
//				若总数达到跟按照此条件列出来的总数一致，则停止加载后台
				console.info(total >= maxItems)
				if (total >= maxItems) {
					// 隐藏加载提示符
...
//					若之前已经选定了别的category，则移除选定的效果，改选成新选定的
